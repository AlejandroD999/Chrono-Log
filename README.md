# Chrono-Log
  Chrono-Log is a Flask project made to simulate a journal by allowing users to record daily moments in the form of summaries that are stored in an SQLite database. 
